...
try:
    ...
    print("unable to set compiler spec for exeception: " + str(exception) + " using " + substitutions['COMPILER_SPEC'] + " for COMPILER_SPEC")
...
try:
    ...
    print("unable to extract OPENSSL_SPEC from external spack.store.db.query due to exeception: " + str(exception))
    try:
        ...
        print("unable to extract OPENSSL_SPEC from external in config packages due to exeception: " + str(exception))
