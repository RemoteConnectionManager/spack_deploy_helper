...
python ${RCM_DEPLOY_ROOTPATH}/scripts/config.py -c config config/shared_install config/rcm config/rcm/client config/rcm/client/darwin  --platformconfig --runconfig --dest ${RCM_DEPLOY_CURRENT_PATH=}
